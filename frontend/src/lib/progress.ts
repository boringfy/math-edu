...
export const COIN_RATES = {
  correct: 2,
  /** Corrections should feel worthwhile even when there is only one mistake. */
  fixed: 3,
  comboMilestone: 2,
  perfect: 5,
...
const BUCKETS: ChallengeDef[][] = [
  [
    { id: 'finishLesson', title: 'Finish a lesson or story', icon: '🎓', target: 1, reward: 10, metric: 'lessonsCleared', mode: 'sum' },
    { id: 'playTwo', title: 'Play 2 rounds', icon: '🎮', target: 2, reward: 10, metric: 'lessonsPlayed', mode: 'sum' },
    { id: 'correct15', title: 'Get 15 answers right', icon: '✅', target: 15, reward: 10, metric: 'correctAnswers', mode: 'sum' },
  ],
  [
    { id: 'perfectLesson', title: 'Get a round completely right', icon: '🌟', target: 1, reward: 10, metric: 'perfectLessons', mode: 'sum' },
    { id: 'fixTwo', title: 'Fix 2 mistakes', icon: '🔧', target: 2, reward: 10, metric: 'mistakesFixed', mode: 'sum' },
    { id: 'correct25', title: 'Get 25 answers right', icon: '🎯', target: 25, reward: 10, metric: 'correctAnswers', mode: 'sum' },
  ],
  [
    { id: 'combo3', title: 'Get 3 right in a row', icon: '🔥', target: 3, reward: 10, metric: 'bestCombo', mode: 'max' },
    { id: 'combo5', title: 'Get 5 right in a row', icon: '🔥', target: 5, reward: 10, metric: 'bestCombo', mode: 'max' },
    { id: 'earnCoins', title: 'Earn 60 coins', icon: '🪙', target: 60, reward: 10, metric: 'coinsEarned', mode: 'sum' },
  ],
];
