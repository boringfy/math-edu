...
import { appendPoint, eraseAround, Point, Stroke, strokePath } from '../lib/scratch';
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.tools}>
        <Pressable
          style={[styles.tool, erasing && styles.toolOn]}
          accessibilityRole="button"
          accessibilityState={{ selected: erasing }}
          accessibilityLabel={erasing ? 'Draw' : 'Eraser'}
          onPress={() => setErasing((on) => !on)}
        >
          <Text style={styles.toolIcon}>{erasing ? '✏️' : '🧽'}</Text>
        </Pressable>
        <Pressable
          style={styles.tool}
          accessibilityRole="button"
